...
-- ----------------------------
INSERT INTO `t_interface_assert_log` VALUES ('1', '1', '122', 'http code == 200', '126', '3', null, '0', '200', '200', '0', '200', '0', null, '2020-11-22 17:22:02');
INSERT INTO `t_interface_assert_log` VALUES ('2', '1', '123', 'sub code == 200', '126', '0', '$..code', '0', '200', '200', '1', '200', '0', null, '2020-11-22 17:22:02');
INSERT INTO `t_interface_assert_log` VALUES ('3', '3', '122', 'http code == 200', '126', '3', null, '0', '200', '200', '0', '200', '0', null, '2020-11-22 17:24:40');
INSERT INTO `t_interface_assert_log` VALUES ('4', '3', '123', 'sub code == 200', '126', '0', '$..code', '0', '200', '200', '1', '200', '0', null, '2020-11-22 17:24:40');
INSERT INTO `t_interface_assert_log` VALUES ('5', '6', '122', 'http code == 200', '126', '3', null, '0', '200', '200', '0', '200', '0', null, '2020-11-22 17:25:18');
INSERT INTO `t_interface_assert_log` VALUES ('6', '6', '123', 'sub code == 200', '126', '0', '$..code', '0', '200', '200', '1', '200', '0', null, '2020-11-22 17:25:18');
...
INSERT INTO `t_interface_case` VALUES ('4', '6', '124', '/user/save', '1', '添加用户-copy', '0', null, '', '', null, '{\"1\":\"${projectNames[0]}\"}', '超级管理员', '2020-11-17 11:17:57', '2020-11-19 11:31:55');
INSERT INTO `t_interface_case` VALUES ('4', '6', '126', '/user/login', '1', '组合用例-1.用户登录', '0', null, '', '{\"username\":\"123\",\"password\":\"123\"}', '', null, '系统管理员', '2020-11-20 15:31:17', '2020-11-20 15:31:17');
INSERT INTO `t_interface_case` VALUES ('4', '10', '127', '/env', '0', '组合用例-2.查看所有的临时变量', '1', null, '{\"Token\":\"#{ztoken}\"}', '', null, null, '系统管理员', '2020-11-20 15:31:54', '2020-11-22 17:25:17');
...
-- ----------------------------
INSERT INTO `t_interface_case_execute_log` VALUES ('1', '126', '组合用例-1.用户登录', 'http://localhost:7777/user/login', '1', '', '{\n	\"password\":\"123\",\n	\"username\":\"123\"\n}', '', null, '', '{\"username\":\"123\",\"password\":\"123\"}', '', null, '200', '{\n	\"Vary\":[\"Origin\",\"Access-Control-Request-Method\",\"Access-Control-Request-Headers\"],\n	\"Content-Type\":[\"application/json\"],\n	\"Transfer-Encoding\":[\"chunked\"],\n	\"Date\":[\"Sun, 22 Nov 2020 09:22:01 GMT\"],\n	\"Keep-Alive\":[\"timeout=60\"],\n	\"Connection\":[\"keep-alive\"]\n}', '{\n	\"msg\":\"登录成功\",\n	\"code\":200,\n	\"data\":{\n		\"realName\":\"系统管理员\",\n		\"userId\":1,\n		\"token\":\"30798316-c35b-4d35-8be7-5427b7570a8f\",\n		\"username\":\"123\",\n		\"isEnable\":1\n	}\n}', '167', '前置用例', '0', '2020-11-22 17:22:01', null, null, null, '[]', '1', '5');
INSERT INTO `t_interface_case_execute_log` VALUES ('2', '127', '组合用例-2.查看所有的临时变量', 'http://localhost:7777/env', '0', '{\n	\"Token\":\"30798316-c35b-4d35-8be7-5427b7570a8f\"\n}', '', '', null, '{\"Token\":\"#{ztoken}\"}', '', null, null, '200', '{\n	\"Vary\":[\"Origin\",\"Access-Control-Request-Method\",\"Access-Control-Request-Headers\"],\n	\"Content-Type\":[\"application/json\"],\n	\"Transfer-Encoding\":[\"chunked\"],\n	\"Date\":[\"Sun, 22 Nov 2020 09:22:01 GMT\"],\n	\"Keep-Alive\":[\"timeout=60\"],\n	\"Connection\":[\"keep-alive\"]\n}', '{\n	\"msg\":\"操作成功\",\n	\"code\":200,\n	\"data\":[]\n}', '12', '系统管理员', '0', '2020-11-22 17:22:02', null, null, null, '[1]', '1', '0');
INSERT INTO `t_interface_case_execute_log` VALUES ('3', '126', '组合用例-1.用户登录', 'http://localhost:7777/user/login', '1', '', '{\n	\"password\":\"123\",\n	\"username\":\"123\"\n}', '', null, '', '{\"username\":\"123\",\"password\":\"123\"}', '', null, '200', '{\n	\"Vary\":[\"Origin\",\"Access-Control-Request-Method\",\"Access-Control-Request-Headers\"],\n	\"Content-Type\":[\"application/json\"],\n	\"Transfer-Encoding\":[\"chunked\"],\n	\"Date\":[\"Sun, 22 Nov 2020 09:24:39 GMT\"],\n	\"Keep-Alive\":[\"timeout=60\"],\n	\"Connection\":[\"keep-alive\"]\n}', '{\n	\"msg\":\"登录成功\",\n	\"code\":200,\n	\"data\":{\n		\"realName\":\"系统管理员\",\n		\"userId\":1,\n		\"token\":\"10f045ea-3b29-4924-ac4d-d829b12e359f\",\n		\"username\":\"123\",\n		\"isEnable\":1\n	}\n}', '58', '前置用例', '0', '2020-11-22 17:24:40', null, null, null, '[]', '1', '5');
INSERT INTO `t_interface_case_execute_log` VALUES ('4', '127', '组合用例-2.查看所有的临时变量', 'http://localhost:7777/env', '0', '{\n	\"Token\":\"10f045ea-3b29-4924-ac4d-d829b12e359f\"\n}', '', '', null, '{\"Token\":\"#{ztoken}\"}', '', null, null, '200', '{\n	\"Vary\":[\"Origin\",\"Access-Control-Request-Method\",\"Access-Control-Request-Headers\"],\n	\"Content-Type\":[\"application/json\"],\n	\"Transfer-Encoding\":[\"chunked\"],\n	\"Date\":[\"Sun, 22 Nov 2020 09:24:39 GMT\"],\n	\"Keep-Alive\":[\"timeout=60\"],\n	\"Connection\":[\"keep-alive\"]\n}', '{\n	\"msg\":\"操作成功\",\n	\"code\":200,\n	\"data\":[]\n}', '12', '系统管理员', '0', '2020-11-22 17:24:40', null, null, null, '[3]', '1', '0');
INSERT INTO `t_interface_case_execute_log` VALUES ('5', '127', '组合用例-2.查看所有的临时变量', 'http://localhost:7777/env', '0', '', '', '', null, '{\"Token\":\"#{ztoken}\"}', '', null, null, null, null, null, '0', '系统管理员', '2', '2020-11-22 17:25:02', '未找到后置处理器ztoken', null, null, '[]', '1', '0');
INSERT INTO `t_interface_case_execute_log` VALUES ('6', '126', '组合用例-1.用户登录', 'http://localhost:7777/user/login', '1', '', '{\n	\"password\":\"123\",\n	\"username\":\"123\"\n}', '', null, '', '{\"username\":\"123\",\"password\":\"123\"}', '', null, '200', '{\n	\"Vary\":[\"Origin\",\"Access-Control-Request-Method\",\"Access-Control-Request-Headers\"],\n	\"Content-Type\":[\"application/json\"],\n	\"Transfer-Encoding\":[\"chunked\"],\n	\"Date\":[\"Sun, 22 Nov 2020 09:25:16 GMT\"],\n	\"Keep-Alive\":[\"timeout=60\"],\n	\"Connection\":[\"keep-alive\"]\n}', '{\n	\"msg\":\"登录成功\",\n	\"code\":200,\n	\"data\":{\n		\"realName\":\"系统管理员\",\n		\"userId\":1,\n		\"token\":\"78e304c7-fc9b-413c-82d5-d7fc7067ab99\",\n		\"username\":\"123\",\n		\"isEnable\":1\n	}\n}', '12', '前置用例', '0', '2020-11-22 17:25:18', null, null, null, '[]', '1', '5');
INSERT INTO `t_interface_case_execute_log` VALUES ('7', '127', '组合用例-2.查看所有的临时变量', 'http://localhost:7777/env', '0', '{\n	\"Token\":\"78e304c7-fc9b-413c-82d5-d7fc7067ab99\"\n}', '', '', null, '{\"Token\":\"#{ztoken}\"}', '', null, null, '200', '{\n	\"Vary\":[\"Origin\",\"Access-Control-Request-Method\",\"Access-Control-Request-Headers\"],\n	\"Content-Type\":[\"application/json\"],\n	\"Transfer-Encoding\":[\"chunked\"],\n	\"Date\":[\"Sun, 22 Nov 2020 09:25:16 GMT\"],\n	\"Keep-Alive\":[\"timeout=60\"],\n	\"Connection\":[\"keep-alive\"]\n}', '{\n	\"msg\":\"操作成功\",\n	\"code\":200,\n	\"data\":[]\n}', '7', '系统管理员', '0', '2020-11-22 17:25:18', null, null, null, '[6]', '1', '0');
...
-- ----------------------------
INSERT INTO `t_interface_case_suite` VALUES ('6', '平台测试套件', '描述', null, '2020-11-21 12:08:07', '', '0', '1', '0');
...
-- ----------------------------
INSERT INTO `t_interface_pre_case` VALUES ('5', '127', '126', '1', '0', '2020-11-22 16:45:54', '2020-11-22 17:25:17');
...
INSERT INTO `t_interface_processor` VALUES ('55', '127', 'zcode', '0', '$..code', null, '1', '2020-11-20 15:34:15', '2020-11-22 17:25:17');
...
-- ----------------------------
INSERT INTO `t_interface_processor_log` VALUES ('1', '54', '126', '1', 'ztoken', '1', '30798316-c35b-4d35-8be7-5427b7570a8f', '0', '$..token', '2020-11-22 17:22:02', '0', null, '1');
INSERT INTO `t_interface_processor_log` VALUES ('2', null, null, null, 'ztoken', null, '30798316-c35b-4d35-8be7-5427b7570a8f', null, null, '2020-11-22 17:22:02', '0', null, '0');
INSERT INTO `t_interface_processor_log` VALUES ('3', '55', '127', '2', 'zcode', '1', '200', '0', '$..code', '2020-11-22 17:22:02', '0', null, '1');
INSERT INTO `t_interface_processor_log` VALUES ('4', '54', '126', '3', 'ztoken', '1', '10f045ea-3b29-4924-ac4d-d829b12e359f', '0', '$..token', '2020-11-22 17:24:40', '0', null, '1');
INSERT INTO `t_interface_processor_log` VALUES ('5', null, null, null, 'ztoken', null, '10f045ea-3b29-4924-ac4d-d829b12e359f', null, null, '2020-11-22 17:24:40', '0', null, '0');
INSERT INTO `t_interface_processor_log` VALUES ('6', '55', '127', '4', 'zcode', '1', '200', '0', '$..code', '2020-11-22 17:24:40', '0', null, '1');
INSERT INTO `t_interface_processor_log` VALUES ('7', '54', '126', '6', 'ztoken', '1', '78e304c7-fc9b-413c-82d5-d7fc7067ab99', '0', '$..token', '2020-11-22 17:25:18', '0', null, '1');
INSERT INTO `t_interface_processor_log` VALUES ('8', null, null, null, 'ztoken', null, '78e304c7-fc9b-413c-82d5-d7fc7067ab99', null, null, '2020-11-22 17:25:18', '0', null, '0');
INSERT INTO `t_interface_processor_log` VALUES ('9', '55', '127', '7', 'zcode', '1', '200', '0', '$..code', '2020-11-22 17:25:18', '0', null, '1');
...
-- ----------------------------
INSERT INTO `t_interface_suite_processor` VALUES ('40', '6', '0', '0', null, '', '2020-11-21 12:08:07', '2020-11-21 12:08:07');
...
INSERT INTO `t_user` VALUES ('12', '1605931676857', '123', null, '0', '1', '2020-11-21 12:07:57', '2020-11-21 12:07:57', '1605931676857', '2');
INSERT INTO `t_user` VALUES ('13', '1605931688242', '123', null, '0', '1', '2020-11-21 12:08:08', '2020-11-21 12:08:08', '1605931688242', '2');
