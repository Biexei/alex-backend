...
-- ----------------------------
INSERT INTO `t_data_factory` VALUES ('1', '执行平台测试套件', '1', '1', '1', null, null, null, '6', null, '2020-11-30 16:34:30', '2020-12-03 11:25:40', '0');
INSERT INTO `t_data_factory` VALUES ('2', '安全测试演示库', '0', '1', '0', '1', '1', '', null, null, '2020-12-01 12:40:18', '2020-12-03 11:43:44', '1');
...
-- ----------------------------
INSERT INTO `t_http_setting` VALUES ('7', '本地代理', 'localhost:8888', '', '1', '0', '2020-10-02 16:14:57', '2020-12-03 10:47:07');
...
INSERT INTO `t_interface_case` VALUES ('4', '10', '127', '/env', '0', '组合用例-2.查看所有的临时变量', '1', null, '{\"Token\":\"#{ztoken}\"}', '', null, null, '系统管理员', '2020-11-20 15:31:54', '2020-12-01 15:35:03');
...
INSERT INTO `t_interface_pre_case` VALUES ('76', '127', '124', '1', '0', '2020-12-01 15:35:03', '2020-12-01 15:35:03');
...
INSERT INTO `t_interface_processor` VALUES ('55', '127', 'zcode', '0', '$..code', null, '1', '2020-11-20 15:34:15', '2020-12-01 15:35:03');
...
CREATE TABLE `t_ui_setting` (
  ...
  `chrome_ops_fullscreen` tinyint DEFAULT NULL COMMENT '全屏0是1否',
  `chrome_ops_maximized` tinyint DEFAULT NULL COMMENT '最大化0是1否',
  `chrome_ops_popup_blocking` tinyint DEFAULT NULL COMMENT '弹出拦截0是1否',
  `chrome_ops_sandbox` tinyint DEFAULT NULL COMMENT '沙盘模式0是1否',
  `chrome_ops_extensions` tinyint DEFAULT NULL COMMENT '禁止扩展0是1否',
  `chrome_ops_infobars` tinyint DEFAULT NULL COMMENT '显示正受到自动测试软件的控制0是1否',
